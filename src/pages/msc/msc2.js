...
const MSC2 = () => {
  ...
  useEffect(() => {
    ...
    setSlots(slots)
    // let msc1 = new MSC2Data(timeInterval, slots);
    if (timeInterval) {
    ...
    <div>
      {
        mscData !== null ?
          <div className="p-grid">
            <div className="p-col-12">MSC2</div>
            ...
            <div className="p-col-12 mtb-1 flex-row-wrap">
              <div className="p-col-6 plr-1">
                ...
                <div className="p-col-12">
                  <PieChart data={mscData.fourthGraph.graphData.data} labels={mscData.fourthGraph.graphData.labels} />
                </div>
              </div>
              <div className="p-col-6 plr-1">
                <div className="p-col-12">
                ...
                <div className="p-col-12">
                  <PieChart data={mscData.fifthGraph.graphData.data} labels={mscData.fifthGraph.graphData.labels} />
                </div>
              </div>
            </div>
